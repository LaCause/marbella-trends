...
const Schema: z.ZodType<Prisma.CategoryUpdateManyWithWhereWithoutLocationsInput> =
  z
    .object({
...
export const CategoryUpdateManyWithWhereWithoutLocationsInputObjectSchema =
  Schema;
