...
const Schema: z.ZodType<Prisma.LocationUncheckedCreateNestedManyWithoutCategoriesInput> =
  z
    .object({
      create: z
        .union([
...
export const LocationUncheckedCreateNestedManyWithoutCategoriesInputObjectSchema =
  Schema;
