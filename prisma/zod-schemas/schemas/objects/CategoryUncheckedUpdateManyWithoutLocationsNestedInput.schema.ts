...
const Schema: z.ZodType<Prisma.CategoryUncheckedUpdateManyWithoutLocationsNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const CategoryUncheckedUpdateManyWithoutLocationsNestedInputObjectSchema =
  Schema;
