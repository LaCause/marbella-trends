...
const Schema: z.ZodType<Prisma.CategoryCreateNestedManyWithoutLocationsInput> =
  z
    .object({
      create: z
        .union([
...
export const CategoryCreateNestedManyWithoutLocationsInputObjectSchema = Schema;
