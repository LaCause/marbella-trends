...
const Schema: z.ZodType<Prisma.LocationUncheckedUpdateManyWithoutCategoriesNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const LocationUncheckedUpdateManyWithoutCategoriesNestedInputObjectSchema =
  Schema;
